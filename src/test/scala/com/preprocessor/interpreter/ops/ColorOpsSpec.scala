...
class ColorOpsSpec extends BaseInterpreterSpec{
	...
	it should "correctly add rgba colors" in {
		...
		assert(ColorOps.addColors(Rgba(255, 255, 255, 255), Rgba(100, 100, 100)) == Rgba(255, 255, 255, 255))
	}

	it should "correctly subtract rgba colors" in {
		assert(ColorOps.subtractColors(Rgba(100, 100, 100), Rgba(200, 200, 200, 200)) == Rgba(0, 0, 0))
